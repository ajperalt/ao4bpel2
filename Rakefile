...
define "ode" do
  ...
  define "axis2" do
    compile.with projects("bpel-api", "bpel-connector", "bpel-dao", "bpel-epr", "bpel-runtime",
      "scheduler-simple", "bpel-schemas", "bpel-store", "utils", "agents", "ao4bpel-factsmanager", "ao4bpel-aspectstore"),
  ...
  define "axis2-war" do
    libs = projects("axis2", "bpel-api", "bpel-compiler", "bpel-connector", "bpel-dao",
      ...
      "utils", "dao-jpa", "agents",  "ao4bpel-factsmanager", "ao4bpel-compiler", "ao4bpel-aspectstore"),
      ...
      AXIS2_MODULES.libs,
	_('../ao4bpel-factsmanager/lib/tuprolog.jar'), _('../ao4bpel-factsmanager/lib/2p.jar')
    ...
    test.with projects("tools", "ao4bpel-factsmanager"), libs, AXIS2_TEST, AXIOM, JAVAX.servlet, Buildr::Jetty::REQUIRES, HIBERNATE, DOM4J, SLF4J, LOG4J, _('../ao4bpel-factsmanager/lib/tuprolog.jar'), _('../ao4bpel-factsmanager/lib/2p.jar')
  ...
  define "ao4bpel-factsmanager" do
  ...
  define "ao4bpel-compiler" do
    compile.with projects("bpel-compiler", "bpel-obj", "utils", "bpel-store"), project("jacob"), COMMONS.logging, WSDL4J, XALAN
    package :jar
  end

  desc "BPEL Aspect Manager"
  define "ao4bpel-aspectstore" do
    compile.with projects("ao4bpel-compiler", "ao4bpel-factsmanager", "bpel-compiler", "bpel-obj", "bpel-api", "utils", "bpel-epr", "bpel-store", "bpel-schemas"), project("jacob"),
	COMMONS.logging, WSDL4J, JAVAX.stream, XMLBEANS
    package :jar
  end
  # /AO4ODE
  ...
  define "bpel-runtime" do
    ...
    compile.with projects("bpel-api", "bpel-compiler", "bpel-dao", "bpel-epr", "bpel-obj", "bpel-schemas",
      "bpel-store", "jacob", "jacob-ap", "utils", "agents", "ao4bpel-factsmanager", "ao4bpel-aspectstore"),
      COMMONS.logging, COMMONS.collections, COMMONS.httpclient, JAXEN, JAVAX.persistence, JAVAX.stream, SAXON, WSDL4J, XMLBEANS,
      SPRING


    test.with projects("scheduler-simple", "dao-jpa", "dao-hibernate", "bpel-epr", "ao4bpel-factsmanager"),
        ...
        DOM4J, HIBERNATE,
        "tranql:tranql-connector-derby-common:jar:1.1", _('../ao4bpel-factsmanager/lib/tuprolog.jar'), _('../ao4bpel-factsmanager/lib/2p.jar')
  ...
  define "jbi" do
    ...
    test.with projects("dao-jpa", "dao-hibernate", "bpel-compiler", "bpel-api-jca", "jca-ra",
      "jca-server", "jacob", "ao4bpel-factsmanager"),
      ...
      LOG4J,
      DOM4J,
      HIBERNATE, _('../ao4bpel-factsmanager/lib/tuprolog.jar'), _('../ao4bpel-factsmanager/lib/2p.jar')
      ...
      pkg.path("#{id}-#{version}").tap do |zip|
        ...
        zip.path("lib").include artifacts(COMMONS.logging, COMMONS.codec, COMMONS.httpclient,
          COMMONS.pool, COMMONS.collections, JAXEN, SAXON, LOG4J, WSDL4J, XALAN, XERCES,
			_('ao4bpel-factsmanager/lib/tuprolog.jar'), _('ao4bpel-factsmanager/lib/2p.jar'))
        project("ode").projects("utils", "tools", "bpel-compiler", "bpel-api", "bpel-obj", "bpel-schemas", "ao4bpel-factsmanager").
